...
"""class NetworkNodes():
    ...
    def __init__(self, name, ip, username='admin', password='password'):
        self.name = name
        self.mgmt_ip_address = ip
        self.username = username
        self.password = password

        self.interfaces = ''

    # Defining connection function
    def connect(self):
        self.session = None

    # defining Action of the script of getting Interfaces summary (Defining the required purpose of script) the default value
    def get_interfaces(self):
        self.interfaces = '--Default Response, We dont know how to get interfaces status--'
"""
