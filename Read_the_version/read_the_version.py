...
def get_devices_list():
    ...
    devices_list = []
    file = open('devices', 'r')
# iterating on appending the extracting the devices in the devices list
    for line in file:
        devices_list.append( line.rstrip() )
# Closing the file is crucial
    file.close()
#list the Device lists in the screen
...
# Connect via SSH Session Code snippet
...
# The Code Block for implementing the defined functions
#-----------------------------------------------------------------------
